  ...
  ><defs
    ><linearGradient
      ...
      ><stop offset="0" stop-color="#f3f7fe" /><stop
        offset=".5"
        stop-color="#f3f7fe"
      /><stop offset="1" stop-color="#deeafb" /></linearGradient
    ><linearGradient
      id="DayDrizzle_b"
      x1="52.7"
      x2="133.4"
    ...
    ><linearGradient
      ...
      ><stop offset="0" stop-color="#0b65ed" /><stop
        offset=".5"
        stop-color="#0a5ad4"
      /><stop offset="1" stop-color="#0950bc" /></linearGradient
    ><linearGradient
      xlink:href="#DayDrizzle_c"
      id="DayDrizzle_d"
      x1="1436.7"
      x2="1454.9"
      y1="-1137"
    ...
    ><symbol id="DayDrizzle_h" viewBox="0 0 196 196"
      ><circle
        cx="98"
        cy="98"
        r="40"
        fill="url(#DayDrizzle_f)"
        stroke="#f8af18"
      ...
      /><path
        ...
        /></path
      ></symbol
    ><symbol id="DayDrizzle_j" viewBox="0 0 200.3 126.1"
      ><path
        fill="url(#DayDrizzle_b)"
        stroke="#848b98"
        stroke-miterlimit="10"
      ...
      /></symbol
    ><symbol id="DayDrizzle_k" viewBox="0 0 350 222"
      ><path
        fill="url(#DayDrizzle_a)"
        stroke="#e6effc"
        stroke-miterlimit="10"
        stroke-width="6"
        d="m291 107-2.5.1A83.9 83.9 0 00135.6 43 56 56 0 0051 91a56.6 56.6 0 00.8 9A60 60 0 0063 219l4-.2v.2h224a56 56 0 000-112Z"
      /></symbol
    ><symbol id="DayDrizzle_i" overflow="visible" viewBox="0 0 398 222"
      ><use
        xlink:href="#DayDrizzle_j"
        width="200.3"
        height="126.1"
        ...
        ><animateTransform
          ...
          values="-9 0; 9 0; -9 0"
        /></use
      ><use xlink:href="#DayDrizzle_k" width="350" height="222"
        ><animateTransform
          additive="sum"
          attributeName="transform"
          dur="6s"
        ...
        /></use
      ></symbol
    ><symbol id="DayDrizzle_g" overflow="visible" viewBox="0 0 410.8 258"
      ><use xlink:href="#DayDrizzle_h" width="196" height="196" /><use
        xlink:href="#DayDrizzle_i"
        width="398"
        height="222"
        transform="translate(12.84 36)"
      /></symbol
    ><symbol id="DayDrizzle_l" overflow="visible" viewBox="0 0 129 57"
      ><path
        fill="url(#DayDrizzle_c)"
        stroke="#0a5ad4"
        stroke-miterlimit="10"
        ...
        ><animateTransform
          ...
          additive="sum"
          attributeName="transform"
          begin="0s; DayDrizzle_x1.end+.33s"
          dur=".67s"
          type="translate"
          values="0 -60; 0 60"
        /><animate
          ...
          begin="0s; DayDrizzle_y1.end+.33s"
          dur=".67s"
          keyTimes="0; .25; 1"
          values="0; 1; 0"
        /></path
      ><path
        fill="url(#DayDrizzle_d)"
        stroke="#0a5ad4"
        stroke-miterlimit="10"
        ...
        ><animateTransform
          ...
          additive="sum"
          attributeName="transform"
          begin=".33s; DayDrizzle_x2.end+.33s"
          dur=".67s"
          type="translate"
          values="0 -60; 0 60"
        /><animate
          id="DayDrizzle_y2"
          attributeName="opacity"
          begin=".33s; DayDrizzle_y2.end+.33s"
          dur=".67s"
          keyTimes="0; .25; 1"
          values="0; 1; 0"
        /></path
      ><path
        fill="url(#DayDrizzle_e)"
        stroke="#0a5ad4"
        stroke-miterlimit="10"
        ...
        ><animateTransform
          ...
          additive="sum"
          attributeName="transform"
          begin="-.33s; DayDrizzle_x3.end+.33s"
          dur=".67s"
          type="translate"
          values="0 -60; 0 60"
        /><animate
          id="DayDrizzle_y3"
          attributeName="opacity"
          begin="-.33s; DayDrizzle_y3.end+.33s"
          dur=".67s"
          keyTimes="0; .25; 1"
          values="0; 1; 0"
        /></path
    ...
    ></defs
  ><use
    xlink:href="#DayDrizzle_g"
    width="410.8"
    height="258"
    transform="translate(56 109)"
  /><use
    xlink:href="#DayDrizzle_l"
    width="129"
    height="57"
