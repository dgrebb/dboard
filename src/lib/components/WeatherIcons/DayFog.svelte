...
<svg
  ...
  ><defs
    ...
    ><symbol id="DayFog_e" viewBox="0 0 384 384"
      ><circle
        cx="192"
        cy="192"
        r="84"
      ...
      /><path
        ...
        /></path
      ></symbol
    ><symbol id="DayFog_f" overflow="visible" viewBox="0 0 264 72"
      ><path
        fill="none"
        stroke="url(#DayFog_a)"
        stroke-linecap="round"
      ...
      ><path
        ...
        /></path
      ></symbol
    ><clipPath id="DayFog_d"><path fill="none" d="M0 0h512v306H0z" /></clipPath
    ></defs
  ><g clip-path="url(#DayFog_d)"
    ><use
      xlink:href="#DayFog_e"
      width="384"
      height="384"
